...
def HeapsortA(A, n, parent):
  ...
  leftnode=parent*4+1
  leftmiddlenode=parent*4+2
  rightmiddlenode=parent*4+3
  rightnode=parent*4+4
  ...
  #Check if leftmiddle node is larger than parent and left node#
  if(leftmiddlenode<n and A[leftmiddlenode]> A[tmp]):
    tmp=leftmiddlenode

  #Check if rightmiddle node is larger than parent and left node#
  if(rightmiddlenode<n and A[rightmiddlenode]> A[tmp]):
    tmp=rightmiddlenode
