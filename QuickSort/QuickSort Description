QuickSort is a divide and conquer sorting algorithum that chooses a element(pivot point), and put all integer larger on the right of the pivot point and vice versa.
